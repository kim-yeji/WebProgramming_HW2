...
<% 
	...
	try
	{
		File file= new File("/root/Desktop/WPsave/Memo");
		File timeFile= new File("/root/Desktop/WPsave/Time/curTime.txt");
		String[] fileNames = file.list();
		
		for(String name : fileNames){
			br = new BufferedReader(new FileReader(new File("/root/Desktop/WPsave/Memo/"+name)));
